...
(function (factory) {
    ...
    $defaults = {
        ...
        icons: {
            ...
            sup: '<span class="fas fa-fw fa-font"></span>',
            bakiniz: '<span class="fas fa-fw fa-eye"></span>',
        ...
        buttonActions: {
            bold: {before: '**', after: '**', 'default': '**(kalın)**', skipSpaces: true},
            italic: {before: '_', after: '_', 'default': '_(italik)_', skipSpaces: true},
            ins: {before: '++', after: '++', 'default': '++(altı çizgili)++', skipSpaces: true},
            // del: {before: '~~', after: '~~', 'default': '_(strikethrough text here)_', skipSpaces: true},
            mark: {before: '==', after: '==', 'default': '==(vuruglanacak metin)==', skipSpaces: true},
            sup: {before: '^(', after: ')^', 'default': '^(anlamtürü buraya gelecek)^', skipSpaces: true},
            ...
            bakiniz: function (str) {
                return function (title) {
                    if (!$h.isEmpty(title)) {
                        str = '[' + title + '](https://kelime.com/arama/' + encodeURIComponent(title) + ')';
                        return str;
                    }
                    return $h.EMPTY;
                };
    ...
    MarkdownEditor.prototype = {
        ...
        showDialog: function (key, callback, str) {
            console.log('showDialog:', key, callback, str);
